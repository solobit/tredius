...
;; generator to customize how certain forms look in the final output. these
;; could have been macros that expand into basic forms, but we want readable
;; output. Special forms are responsible for integrity checking of the form.
...
(defn compile-link [form]
 (if (string? form) (str "REF: " form)))

(install-native '~> ' nil compile-link)
