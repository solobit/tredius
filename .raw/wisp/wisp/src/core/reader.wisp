...
;; ~~~~~~~~~~~~~~~~~~~~~~~~~~
;;
;; Predicates are by nature functions; a special branch of functions which,
;; nearly always returns a boolean true/false value. These are to support the
;; reader.
;;
;; newline? breaking-whitespace? whitespace? numeric? comment-prefix?
;; number-literal?
...
;; ~~~~~~~~~~~~~~~~~~~~~~
;;
;; Patterns:    int-pattern ratio-pattern float-pattern
;; Predicates:  macro-terminating?

;; Functions:   reader-error read-token skip-line match-int match-ratio
;;              match-float match-number escape-char-map
...
;; ~~~~~~~~~~~~~~~~~~~~~~~~
;;
;; Private:     read-uuid read-queue
;; Special:     **tag-table**;;
;; Patterns:    unicode-2-pattern unicode-4-pattern

;; Functions:   read-2-chars read-4-chars validate-unicode-escape
;;              make-unicode-char escape-char read-past read-delimited-list
;;              not-implemented read-dispatch read-unmatched-delimiter read-list
;;              read-string read-unquote special-symbols read-symbol read-keyword
;;              desugar-meta wrapping-reader throwing-reader read-meta read-regex
;;              read-param param? lambda-params-hash lambda-params read-lambda
;;              read-discard macros dispatch-macros read-form read read-from-string
;;
