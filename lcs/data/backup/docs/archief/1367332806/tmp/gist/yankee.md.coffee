...
### Request + Cheerio
Source(s): <http://procbits.com/2012/04/11/quick-and-dirty-screen-scraping-with-node-js-using-request-and-cheerio>

One easy way to scrape pages with Node.js is to use [Request][req] and [Cheerio][yay].
...
[yay]: <https://github.com/MatthewMueller/cheerio>
