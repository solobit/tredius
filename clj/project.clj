(defproject
  ...
  [[enlive "1.1.1"] ; scraping
   ...
   [clojure-opennlp "0.3.0"] ;; language proc
   ...
   ;[ring/ring-devel "1.2.0-beta3"] ; -> all
   ;[org.clojure/core.logic "0.8.3"] ; needed ??
   ;[ring/ring-jetty-adapter "1.1.8"] ; -> all
   ...
   [com.quantisan/clatrix "0.2.2"        :exclusions [slingshot
                                                      org.jblas/jblas]]
