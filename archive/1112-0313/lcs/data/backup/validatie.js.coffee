...
$(document).ready ->
  ...
  # Allereerst zoeken we, wanneer dit script wordt aangeroepen, alle input
  # elementen met de klasse 'valideer' op
  $("input.valideer").each ->

    # en voegen  een aantal onzichtbare markeringen toe
